...
GOWORK=off go mod edit \
    ...
    -require=github.com/faustbrian/go-search/adapters/opensearch@v0.0.0 \
    -require=github.com/faustbrian/go-tenancy@v0.0.0 \
    -replace="github.com/faustbrian/go-search=${repository_root}/pkg/search" \
    -replace="github.com/faustbrian/go-search/adapters/opensearch=${repository_root}/pkg/search/adapters/opensearch" \
